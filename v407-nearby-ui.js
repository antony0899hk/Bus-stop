(() => {
  ...
  // v4.0.8: the search handler runs earlier and stops propagation, so the UI click
  // handler may not see the radius click. Keep UI synced from the actual search status.
